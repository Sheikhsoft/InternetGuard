...
public class ActivityLog extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    private static final String TAG = "InterNetGuard.Log";
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        File pcap_file = new File(getDir("data", MODE_PRIVATE), "internetguard.pcap");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        final SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
        final File pcap_file = new File(getDir("data", MODE_PRIVATE), "internetguard.pcap");
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_log_support:
                ...
                intent.setData(Uri.parse("http://internetguard.sheikhsoft.com/faq.php#FAQ27"));
            ...
            protected Throwable doInBackground(Object... objects) {
                ...
                try {
                    ...
                    if (data.hasExtra("org.openintents.extra.DIR_PATH"))
                        target = Uri.parse(target + "/internetguard.pcap");
                    Log.i(TAG, "Export PCAP URI=" + target);
                    out = getContentResolver().openOutputStream(target);

                    File pcap = new File(getDir("data", MODE_PRIVATE), "internetguard.pcap");
