...
public class ServiceExternal extends IntentService {
    private static final String TAG = "InterNetGuard.External";
    private static final String ACTION_DOWNLOAD_HOSTS_FILE = "eu.sheikhsoft.internetguard.DOWNLOAD_HOSTS_FILE";

    // am startservice -a eu.faircode.internetguard.DOWNLOAD_HOSTS_FILE
