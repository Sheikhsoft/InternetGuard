...
public class ActivityPro extends AppCompatActivity {
    private static final String TAG = "InterNetGuard.Pro";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Linkify.addLinks(tvLogTitle, Pattern.compile(".*"), "http://www.internetguard.me/#" + SKU_LOG, null, filter);
        Linkify.addLinks(tvFilterTitle, Pattern.compile(".*"), "http://www.internetguard.me/#" + SKU_FILTER, null, filter);
        Linkify.addLinks(tvNotifyTitle, Pattern.compile(".*"), "http://www.internetguard.me/#" + SKU_NOTIFY, null, filter);
        Linkify.addLinks(tvSpeedTitle, Pattern.compile(".*"), "http://www.internetguard.me/#" + SKU_SPEED, null, filter);
        Linkify.addLinks(tvThemeTitle, Pattern.compile(".*"), "http://www.internetguard.me/#" + SKU_THEME, null, filter);
        Linkify.addLinks(tvAllTitle, Pattern.compile(".*"), "http://www.internetguard.me/#" + SKU_PRO1, null, filter);
        Linkify.addLinks(tvDev1Title, Pattern.compile(".*"), "http://www.internetguard.me/#" + SKU_SUPPORT1, null, filter);
        Linkify.addLinks(tvDev2Title, Pattern.compile(".*"), "http://www.internetguard.me/#" + SKU_SUPPORT2, null, filter);
